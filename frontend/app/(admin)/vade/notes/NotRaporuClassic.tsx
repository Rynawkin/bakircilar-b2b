...
/**
 * Klasik (mevcut) Not Raporu gorunumu. JSX, eski page.tsx ile BIRE BIR aynidir;
 * tek fark: tum state/handler/turetilmis deger useNotRaporu hook'undan gelir.
 */
export default function NotRaporuClassic() {
  const {
    notes,
    staff,
    loading,
