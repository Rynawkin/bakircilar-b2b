...
/**
 * Klasik gorunum - Operasyon Komuta Merkezi.
 * Mevcut JSX birebir korunmustur; tum mantik useOperasyon hook'undan gelir.
 */
export default function OperasyonClassic() {
  const {
    router,
    permissionLoading,
    canAccess,
