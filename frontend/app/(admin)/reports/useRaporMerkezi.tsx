...
export const reports: ReportCard[] = [
  ...
  {
    id: 'discount-below-entry-cost',
    title: 'Indirimli Fiyati Giris Maliyeti Altinda',
    description: 'Indirimli satis fiyati son giris maliyetinin altina dusen urunleri yakalayip hatali guncel maliyeti duzeltin',
    icon: <TrendingDown className="h-5 w-5" />,
    href: '/reports/discount-below-entry-cost',
    category: 'cost',
    badge: 'Yeni',
    tags: ['Fiyat', 'Maliyet', 'Aksiyon'],
    highImpact: true,
    permission: 'reports:cost-update-alerts',
  },
  {
  ...
  {
    id: 'margin-violations',
    title: 'Marj Ihlali Aksiyon Merkezi',
    description: 'Maliyet alti satislari sorumlu, not, teyit ve kapatma akisi ile yonetin',
    icon: <AlertTriangle className="h-5 w-5" />,
    href: '/margin-violations',
    category: 'cost',
    badge: 'Aksiyon',
    tags: ['Marj', 'Satici', 'Takip'],
    highImpact: true,
    permission: 'reports:margin-violations',
  },
  {
    id: 'profit-analysis',
    title: 'Urun Kar Dagilimi',
    description: 'Kategori maliyeti bazinda urun kar dagilimini ve detay analizini inceleyin',
  ...
  },
  {
    ...
    title: 'Aile Yonetimi',
    description: 'Aile onerileri, yeni aile adaylari ve supheli uyeleri tek ekrandan yonetin',
    icon: <Warehouse className="h-5 w-5" />,
    href: '/reports/family-management',
    category: 'stock',
    badge: 'Yeni',
    tags: ['Aile', 'Stok', 'Oneri'],
