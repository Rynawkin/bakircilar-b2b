...
import { ChevronRight, BadgeCheck, Search, ArrowDownUp, Warehouse } from 'lucide-react';
      ...
      <div className={CONTAINER}>
        ...
        <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold tracking-tight text-[var(--ink-1)]">Anlaşmalı Ürünler</h1>
        ...
        <div className="card mb-5 flex flex-wrap items-center gap-2.5 px-3.5 py-3">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full border border-primary-100 bg-primary-50 px-3 py-1.5 text-[12px] font-semibold text-primary-700">
        ...
        {isLoading ? (
          ...
          <Card>
            <EmptyState
              ...
              title={search || selectedCategory || warehouse ? 'Ürün bulunamadı' : 'Anlaşmalı ürün bulunamadı'}
              description={
