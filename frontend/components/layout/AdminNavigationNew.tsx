          ...
          <Menu as="div" className="relative">
            ...
            >
              <Menu.Items className={`absolute right-0 mt-2 w-80 overflow-hidden ${dropdownPanel}`}>
                ...
                <div className="border-b border-[var(--line)] bg-[var(--surface-0)] px-3.5 py-3">
                  <button
                    type="button"
                    onClick={handleEnableBrowserPush}
                    disabled={pushBusy}
                    className="mb-2 w-full rounded-lg border border-[var(--line)] bg-white px-3 py-2 text-left text-[12px] font-semibold text-[var(--ink-1)] transition-colors hover:bg-primary-50 disabled:opacity-60"
                  >
