...
router.patch('/admin/orders/:mikroOrderNumber/line-quantity', authenticate, requirePermission('admin:order-tracking'), orderTrackingController.updateOrderLineQuantity);
