  ...
  async searchStocks(params: StockF10SearchParams = {}): Promise<any> {
    ...
    const query = `
      SELECT TOP ${limit}
        ...
        dbo.fn_StokSatisFiyati (sto_kod, 13, 0,1) AS [F-6],
        dbo.fn_StokSatisFiyati (sto_kod, 11, 0,1) AS [Kampanya F],
        ...
        dbo.fn_StokSatisFiyati (sto_kod, 14, 0,1) AS [P-6],
        dbo.fn_StokSatisFiyati (sto_kod, 12, 0,1) AS [Kampanya P],
