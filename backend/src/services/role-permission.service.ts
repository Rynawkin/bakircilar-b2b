...
export const AVAILABLE_PERMISSIONS = {
  ...
  'reports:customer-recovery': 'Cari Geri Kazanim Raporu',
...
export const PERMISSION_DESCRIPTIONS = {
  ...
  'reports:customer-recovery': 'Kaybedilen veya hareketi dusen carileri not ve takip aksiyonlariyla izleme raporuna erisim izni verir',
