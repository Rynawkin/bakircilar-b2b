...
export const AVAILABLE_PERMISSIONS = {
  ...
  'reports:complement-missing': 'Kategori ve Capraz Satis Karar Raporlari',
  'reports:customer-recovery': 'Satisi Dusen veya Duran Cariler',
  'reports:customer-engagement': 'Cari Aktivite ve Temas Takibi',
  ...
  'admin:stock-create': 'Yeni Stok Karti Acma',
  'admin:field-sales': 'Saha Satis',
  'admin:hot-sales': 'Sicak Satis',
...
export const PERMISSION_DESCRIPTIONS = {
  ...
  'reports:complement-missing': 'Kategori-cari alim kesintisi, yeni kategori kazandirma ve tamamlayici urun firsati raporlarina erisim izni verir',
  'reports:customer-recovery': 'Toplam satisi dusen veya duran carileri not ve takip aksiyonlariyla izleme raporuna erisim izni verir',
  'reports:customer-engagement': 'Carilerin B2B giris/siparis aktivitesini, durumunu ve temas/hatirlatma gecmisini izleme raporuna erisim izni verir',
  ...
  'admin:stock-create': 'B2B uzerinden Mikroda tekli ve toplu yeni stok karti acma izni verir',
  'admin:field-sales': 'Saha satis mobil ekranina erisim izni verir',
  'admin:hot-sales': 'Arac stogu, sicak satis, tahsilat ve gun sonu mutabakat ekranlarina erisim izni verir',
