...
- **Stok ailesi yönlendirme uyarısı (kalem altı — mevcut özellik, KORUNACAK):** Ürün bir **stok ailesinde** ise miktar girilince satırın hemen altında (marginInfo gibi tam genişlik satır) uyarı çıkar. İki tip: (a) **kırmızı** "girilen ürünün stoğu yetmiyor; ailedeki {ürün} {n} adetle karşılar → **Değiştir**"; (b) **amber/yatan stok** "ailede {ürün} fazla (yatan) stoklu → **Böl: X yatan stoktan, Y mevcuttan** / **Tamamını aktar**". Küçük "yoksay (×)" butonu olmalı. Redesign'da bu blok için yer ayrılmalı.
