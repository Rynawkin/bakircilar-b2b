...
| 0.3 | Footer (yeni) | ✅ (AdminFooterNew — sadece yeni temada) |

## 1. Teklif & Sipariş (en kritik)
| # | Ekran | Route | Durum |
|---|---|---|---|
| 1.1 | Teklif Oluştur/Düzenle (+ sipariş modu) ⭐⭐⭐ | /quotes/new | ✅ (hook+Classic+New; AI butonu + StockFamilySuggestion korundu) |
| 1.2 | Teklif Listesi | /quotes | ✅ (hook+Classic+New) |
| 1.3 | Teklifi Siparişe Çevir | /quotes/convert/[id] | ✅ (hook+Classic+New) |
...
| # | Ekran | Route | Durum |
|---|---|---|---|
| 3.1 | Saha Satış | /field-sales | ✅ (hook+Classic+New) |
| 3.2 | Sıcak Satış | /hot-sales | ✅ (hook+Classic+New) |
| 3.3 | Depo Kiosk | /warehouse | ✅ (hook+Classic+New) |
...
| # | Ekran | Route | Durum |
|---|---|---|---|
| 7.1 | Tedarik Maliyetleri (Teyit/İhale dahil) | /supplier-costs | ✅ (hook+Shared+Classic+New; mark-current korundu) |
...
| # | Ekran | Route | Durum |
|---|---|---|---|
| 10.1 | Üçarer Depo ve MinMax | /reports/ucarer-depo | ✅ (hook+Classic+New) |
